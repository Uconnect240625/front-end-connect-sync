...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="bg-card shadow-sm border-b border-border px-4 py-3 relative z-50">
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              >
                ...
                <span className="text-sm font-medium hidden md:block text-card-foreground">{profile.full_name}</span>
              </div>
              
              {isProfileDropdownOpen && (
                <div className="absolute right-0 top-12 bg-card border border-border rounded-lg shadow-lg min-w-48 z-50">
                  <div className="p-3 border-b border-border">
                    <p className="font-medium text-sm text-card-foreground">{profile.full_name}</p>
                  ...
                  <div className="py-1">
                    <button
                      ...
                      className="w-full text-left px-4 py-2 text-sm hover:bg-accent text-card-foreground flex items-center space-x-2"
                    >
                      <User size={16} />
                    ...
                    {profile.role === 'admin' && (
                      <button
                        ...
                        className="w-full text-left px-4 py-2 text-sm hover:bg-accent flex items-center space-x-2 text-red-600"
                      >
                        <Shield size={16} />
      ...
      {/* Sidebar */}
      <div className={`fixed top-0 right-0 h-full w-64 bg-card shadow-lg transform transition-transform duration-300 z-40 border-l border-border ${
        ...
        <div className="py-4">
          {navigationItems.map((item) => (
            <button
              ...
              className={`w-full text-left px-6 py-3 hover:bg-accent flex items-center space-x-3 text-card-foreground hover:text-accent-foreground ${
