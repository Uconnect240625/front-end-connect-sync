...
const UConnect = () => {
  ...
  const features = [{
    name: 'Notes Hub',
    icon: 'https://img.icons8.com/color/96/open-book--v1.png',
    route: '/notes'
  }, {
    name: 'PG Finder',
    icon: 'https://img.icons8.com/color/96/bedroom.png',
    route: '/pg-finder'
  }, {
    name: 'Marketplace',
      ...
      <div className="flex justify-center items-center py-8">
        <div className="w-full max-w-lg p-8">
          <header className="text-center mb-8">
            <h1 className="text-4xl text-foreground mb-2 font-bold">
          ...
          <section className="grid grid-cols-2 gap-5">
            {features.map((feature, index) => <div key={index} className="bg-card rounded-2xl p-4 text-center shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-accent cursor-pointer border border-border" onClick={() => openFeature(feature.route)}>
                <img src={feature.icon} alt={feature.name} className="w-12 h-12 mx-auto mb-3" />
          ...
          <div className="text-center mt-8 space-y-3">
            <div className="flex gap-2 justify-center flex-wrap">
              ...
              <button onClick={() => navigate('/notifications')} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm">
                🔔 Notifications
              </button>
            </div>
            ...
            <div className="flex gap-2 justify-center flex-wrap">
              ...
              <button onClick={() => navigate('/upload-notes')} className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors text-sm">
                📤 Upload Notes
              </button>
